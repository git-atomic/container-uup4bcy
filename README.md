...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uup4bcy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uup4bcy.containers.anotherwebservice.com/
...
```
git clone git@github.com:git-atomic/container-uup4bcy.git
cd container-uup4bcy
```
...
```
docker attach container-uup4bcy
```
